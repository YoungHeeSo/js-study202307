...
//화면 가장 상단분에 들어갈 장바구니 총액 정보 태그 생성 클래스
class ShoppingCart{
  constructor(){
...
class ProductItem {
  ...
  render() {
    ...
    $prod.innerHTML = `
      ...
      //!!중요
      // $addCarBtn.addEventListener('click', this.addToCartHandler.bind(this));
      $addCarBtn.addEventListener('click', ()=> this.addToCartHandler());
